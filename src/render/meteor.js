...
const METEOR_SHOWERS = [
  { name: '象限仪座流星雨', radiant: { ra: 230, dec: 49 }, peak: '0103', rate: 120, active: '1228-0112' },
  { name: '天琴座流星雨', radiant: { ra: 271, dec: 34 }, peak: '0422', rate: 18, active: '0416-0425' },
  { name: '宝瓶座η流星雨', radiant: { ra: 338, dec: -1 }, peak: '0505', rate: 50, active: '0419-0528' },
  { name: '英仙座流星雨', radiant: { ra: 48, dec: 58 }, peak: '0812', rate: 100, active: '0717-0824' },
  { name: '猎户座流星雨', radiant: { ra: 95, dec: 16 }, peak: '1021', rate: 20, active: '1002-1107' },
  { name: '狮子座流星雨', radiant: { ra: 152, dec: 22 }, peak: '1117', rate: 15, active: '1106-1130' },
  { name: '双子座流星雨', radiant: { ra: 112, dec: 33 }, peak: '1214', rate: 150, active: '1204-1217' },
  { name: '小熊座流星雨', radiant: { ra: 217, dec: 76 }, peak: '1222', rate: 10, active: '1217-1226' }
];
...
export class MeteorRenderer {
  ...
  checkActivity(date) {
    ...
    for (const shower of METEOR_SHOWERS) {
      ...
      if (dateStr >= start && dateStr <= end) {
        ...
        const daysFromPeak = Math.abs(parseInt(dateStr) - parseInt(peak));
  ...
  start(shower) {
    ...
    this.meteors = [];
    console.log(`🌠 ${shower.name} 开始，强度: ${(shower.intensity * 100).toFixed(0)}%`);
  }
  ...
  update(deltaTime) {
    ...
    for (let i = this.meteors.length - 1; i >= 0; i--) {
      ...
      // 移动流星
      meteor.mesh.position.add(meteor.velocity.clone().multiplyScalar(deltaTime));
